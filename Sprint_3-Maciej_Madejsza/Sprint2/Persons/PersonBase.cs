...
abstract class PersonBase : IDatabaseObject
{
    ...
    //--------------Getters:--------------------------------------
    // Method providing all personToListBy details formatted in a block of information
    public virtual string GetFullDetails()
    {
        return
            ...
            $"E-mail: {this.e_mail}\n" +
            $"Premium: {(this.IsPremium()==false?"No":"Yes")}\n" +
            $"Flagged: {(this.IsRedFlagged() == false ? "No" : "Yes")}\n";
    }
    ...
    public virtual string Suspend(Landlord personForActionSelection) => "";
    public virtual string Restore(Landlord personForActionSelection) => "";
    public virtual string Book(Tenant personForActionSelection) => "";
    public virtual string Release(Tenant personForActionSelection) => "";
