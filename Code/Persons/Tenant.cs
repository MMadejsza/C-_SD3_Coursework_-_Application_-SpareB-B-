...
class Tenant : PersonBase
{
    ...
    public void Book(PropBase property) => property.Book(this);
    ...
    public void Release(PropBase property) => property.Release(this);
    ...
    public void GetBookings() => database.Search("properties", "person", this);
}